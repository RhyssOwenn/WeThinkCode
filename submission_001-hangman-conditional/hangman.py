...
def select_random_word(words):
    ...
    word = words[random_index].rstrip()
    return word
...
def select_random_letter_from(word):
    ...
    print('Guess the word: ' + word[:random_index] + "_" + word[random_index+1:len(word)])
...
# TODO: Step 2
def ask_file_name():
    answer = input("Words file? [leave empty to use short_words.txt] :")
    if answer == "":
